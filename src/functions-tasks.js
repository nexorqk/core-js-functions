...
function getCurrentFunctionName() {
  ...
  return getFunctionName(getCurrentFunctionName);
}
...
function memoize(func) {
  ...
  function memoFnc() {
    if (memoizedObj[func] !== undefined) return memoizedObj[func];
    const memo = func();
    memoizedObj[func] = memo;
...
function getIdGeneratorFunction(startFrom) {
  let generatorNum = startFrom;
  function generatorFunction() {
    const currentNum = generatorNum;
    generatorNum += 1;
    return currentNum;
  }
